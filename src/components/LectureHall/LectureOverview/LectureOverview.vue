<template>
  <div class="lectureOverview">
    ...
    <div class="operating">
      <div class="left">
        <el-button class="btn" size="mini" @click="linkTo('/home/lectureHall/addLecture')">
        ...
        <el-button class="btn" size="mini" @click="linkTo('/home/lectureHall/searchAllLecture')">
